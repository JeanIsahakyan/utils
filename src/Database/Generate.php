...
class Generate {
  ...
  public static function create(AbstractDatabase $db, string $name, string $dir, string $namespace): self {
    return new self($db, $name, $dir, $namespace);
  }
  ...
  public function get{$func_name}Value(string \$name): mixed {
    return \$this->get{$func_name}()[\$name];
  }
